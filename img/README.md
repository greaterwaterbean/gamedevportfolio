...
- `img/sprites/` — animated sprite strips (one row of frames per animation) cut from 0x72's CC0 DungeonTileset II. Frame sizes are set per sprite in the `GAME LAYER` block of `css/style.css`.
